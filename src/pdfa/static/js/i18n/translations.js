...
export const translations = {
            en: {
                ...
                'camera.mobile.action': '🔗 Pair Device',
                'camera.pairing.title': '📱 Link Mobile Device',
                'camera.pairing.start': 'Start Mobile Pairing',
                'camera.pairing.waiting': 'Waiting for mobile...',
                'camera.pairing.connected': 'Mobile connected ✓',
                'camera.pairing.disconnected': 'Mobile disconnected',
                'camera.pairing.code': 'Pairing Code:',
                'camera.pairing.qrHint': 'or scan QR code below',
                'camera.pairing.expiresIn': '⏱️ Expires in',
                'camera.pairing.imagesReceived': '📸 Images received:',
                'camera.pairing.cancel': 'Cancel Pairing',
                // Mobile Camera translations
                'mobile.title': '📷 Mobile Camera',
                'mobile.subtitle': 'Link to Desktop Session',
                'mobile.pairingCode.label': 'Enter Pairing Code:',
                'mobile.pairingCode.placeholder': 'ABC123',
                'mobile.connect': 'Connect',
                'mobile.help': 'Scan the QR code on your desktop or enter the pairing code manually.',
                'mobile.connected': 'Connected to Desktop',
                'mobile.imagesSent': 'sent',
                'mobile.switch': 'Switch',
                'mobile.disconnect': 'Disconnect',
                'mobile.editImage': 'Edit Image',
                'mobile.rotateLeft': 'Rotate Left',
                'mobile.rotateRight': 'Rotate Right',
                'mobile.retake': 'Retake',
                'mobile.sendToDesktop': 'Send to Desktop',
                'mobile.errors.failedToConnect': 'Failed to connect. Please check the code and try again.',
                'mobile.errors.cameraAccess': 'Failed to access camera. Please check permissions.',
                'mobile.errors.noCameraSwitch': 'No other camera available',
            ...
            de: {
                ...
                'camera.mobile.action': '🔗 Gerät koppeln',
                'camera.pairing.title': '📱 Mobilgerät verbinden',
                'camera.pairing.start': 'Mobile-Kopplung starten',
                'camera.pairing.waiting': 'Warte auf Mobilgerät...',
                'camera.pairing.connected': 'Mobilgerät verbunden ✓',
                'camera.pairing.disconnected': 'Mobilgerät getrennt',
                'camera.pairing.code': 'Kopplungscode:',
                'camera.pairing.qrHint': 'oder QR-Code unten scannen',
                'camera.pairing.expiresIn': '⏱️ Läuft ab in',
                'camera.pairing.imagesReceived': '📸 Bilder empfangen:',
                'camera.pairing.cancel': 'Kopplung abbrechen',
                // Mobile Kamera-Übersetzungen
                'mobile.title': '📷 Mobile-Kamera',
                'mobile.subtitle': 'Mit Desktop-Sitzung verbinden',
                'mobile.pairingCode.label': 'Kopplungscode eingeben:',
                'mobile.pairingCode.placeholder': 'ABC123',
                'mobile.connect': 'Verbinden',
                'mobile.help': 'Scannen Sie den QR-Code auf Ihrem Desktop oder geben Sie den Kopplungscode manuell ein.',
                'mobile.connected': 'Mit Desktop verbunden',
                'mobile.imagesSent': 'gesendet',
                'mobile.switch': 'Wechseln',
                'mobile.disconnect': 'Trennen',
                'mobile.editImage': 'Bild bearbeiten',
                'mobile.rotateLeft': 'Nach links drehen',
                'mobile.rotateRight': 'Nach rechts drehen',
                'mobile.retake': 'Erneut aufnehmen',
                'mobile.sendToDesktop': 'An Desktop senden',
                'mobile.errors.failedToConnect': 'Verbindung fehlgeschlagen. Bitte überprüfen Sie den Code und versuchen Sie es erneut.',
                'mobile.errors.cameraAccess': 'Kamerazugriff fehlgeschlagen. Bitte überprüfen Sie die Berechtigungen.',
                'mobile.errors.noCameraSwitch': 'Keine andere Kamera verfügbar',
            ...
            es: {
                ...
                'camera.mobile.action': '🔗 Vincular Dispositivo',
                'camera.pairing.title': '📱 Vincular Dispositivo Móvil',
                'camera.pairing.start': 'Iniciar Emparejamiento Móvil',
                'camera.pairing.waiting': 'Esperando móvil...',
                'camera.pairing.connected': 'Móvil conectado ✓',
                'camera.pairing.disconnected': 'Móvil desconectado',
                'camera.pairing.code': 'Código de Emparejamiento:',
                'camera.pairing.qrHint': 'o escanee el código QR a continuación',
                'camera.pairing.expiresIn': '⏱️ Expira en',
                'camera.pairing.imagesReceived': '📸 Imágenes recibidas:',
                'camera.pairing.cancel': 'Cancelar Emparejamiento',
                // Traducciones de Cámara Móvil
                'mobile.title': '📷 Cámara Móvil',
                'mobile.subtitle': 'Conectar a Sesión de Escritorio',
                'mobile.pairingCode.label': 'Ingresar Código de Emparejamiento:',
                'mobile.pairingCode.placeholder': 'ABC123',
                'mobile.connect': 'Conectar',
                'mobile.help': 'Escanee el código QR en su escritorio o ingrese el código de emparejamiento manualmente.',
                'mobile.connected': 'Conectado al Escritorio',
                'mobile.imagesSent': 'enviadas',
                'mobile.switch': 'Cambiar',
                'mobile.disconnect': 'Desconectar',
                'mobile.editImage': 'Editar Imagen',
                'mobile.rotateLeft': 'Girar a la Izquierda',
                'mobile.rotateRight': 'Girar a la Derecha',
                'mobile.retake': 'Volver a Tomar',
                'mobile.sendToDesktop': 'Enviar al Escritorio',
                'mobile.errors.failedToConnect': 'Error al conectar. Por favor, verifique el código e intente nuevamente.',
                'mobile.errors.cameraAccess': 'Error al acceder a la cámara. Por favor, verifique los permisos.',
                'mobile.errors.noCameraSwitch': 'No hay otra cámara disponible',
            ...
            fr: {
                ...
                'camera.mobile.action': '🔗 Appairer Appareil',
                'camera.pairing.title': '📱 Lier Appareil Mobile',
                'camera.pairing.start': 'Démarrer Appairage Mobile',
                'camera.pairing.waiting': 'En attente du mobile...',
                'camera.pairing.connected': 'Mobile connecté ✓',
                'camera.pairing.disconnected': 'Mobile déconnecté',
                'camera.pairing.code': 'Code d\'Appairage :',
                'camera.pairing.qrHint': 'ou scannez le code QR ci-dessous',
                'camera.pairing.expiresIn': '⏱️ Expire dans',
                'camera.pairing.imagesReceived': '📸 Images reçues :',
                'camera.pairing.cancel': 'Annuler l\'Appairage',
                // Traductions de Caméra Mobile
                'mobile.title': '📷 Caméra Mobile',
                'mobile.subtitle': 'Lier à la Session Bureau',
                'mobile.pairingCode.label': 'Entrer le Code d\'Appairage :',
                'mobile.pairingCode.placeholder': 'ABC123',
                'mobile.connect': 'Connecter',
                'mobile.help': 'Scannez le code QR sur votre bureau ou entrez le code d\'appairage manuellement.',
                'mobile.connected': 'Connecté au Bureau',
                'mobile.imagesSent': 'envoyées',
                'mobile.switch': 'Changer',
                'mobile.disconnect': 'Déconnecter',
                'mobile.editImage': 'Modifier l\'Image',
                'mobile.rotateLeft': 'Pivoter à Gauche',
                'mobile.rotateRight': 'Pivoter à Droite',
                'mobile.retake': 'Reprendre',
                'mobile.sendToDesktop': 'Envoyer au Bureau',
                'mobile.errors.failedToConnect': 'Échec de la connexion. Veuillez vérifier le code et réessayer.',
                'mobile.errors.cameraAccess': 'Échec de l\'accès à la caméra. Veuillez vérifier les autorisations.',
                'mobile.errors.noCameraSwitch': 'Aucune autre caméra disponible',
